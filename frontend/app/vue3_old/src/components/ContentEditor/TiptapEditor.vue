...
<template>
  ...
  >
    ...
    <n-modal
      ...
      @positive-click="handleLinkOk"
      @negative-click="handleLinkCancel"
    >
      <n-input
    ...
    <n-modal
      v-model:show="codeBlockModalVisible"
      :title="$t('ui.editor.insertCodeBlock')"
      preset="dialog"
      :positive-text="$t('common.confirm') || 'OK'"
      :negative-text="$t('common.cancel') || 'Cancel'"
      @positive-click="handleCodeBlockOk"
      @negative-click="handleCodeBlockCancel"
      style="width: 600px"
    >
      <div class="code-block-modal">
        ...
        <div class="modal-field">
          ...
          <n-input
            v-model:value="codeBlockContent"
            type="textarea"
    ...
    <n-modal
      ...
      :positive-text="$t('common.confirm') || 'OK'"
      :negative-text="$t('common.cancel') || 'Cancel'"
      @positive-click="handleVideoOk"
      @negative-click="handleVideoCancel"
      style="width: 500px"
    >
    ...
    <!-- Iframe Insert Modal -->
    <n-modal
      v-model:show="iframeModalVisible"
      :title="$t('ui.editor.insertIframe')"
      preset="dialog"
      :positive-text="$t('common.confirm') || 'OK'"
      :negative-text="$t('common.cancel') || 'Cancel'"
      @positive-click="handleIframeOk"
      @negative-click="handleIframeCancel"
      style="width: 500px"
    >
      <div class="iframe-modal">
        ...
        <div class="modal-field">
          ...
          <div style="display: flex; gap: 12px; align-items: center">
            <n-switch v-model:value="iframeAllowFullscreen"/>
            <span>{{
