    ...
    translations: [
      {
        ...
        slug: 'about',
        summary: '了解我们的团队和使命',
        content: `# 关于 GoWind Content Hub

GoWind Content Hub 是一个强大的多租户 Content Hub 平台，为现代团队提供灵活的内容管理解决方案。
...
const pageEnMap: Record<string, {
  ...
  about: {
    ...
    content: `# About GoWind Content Hub

GoWind Content Hub is a powerful multi-tenant headless content hub that provides flexible content management for modern teams.
