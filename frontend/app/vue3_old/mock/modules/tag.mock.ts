    ...
    translations: [
      {
        ...
        description: '内容中台',
        seoTitle: '内容中台设计和实现',
        metaDescription: '内容中台的设计原理、架构和实现方案',
        metaKeywords: '内容中台,架构设计,系统设计',
