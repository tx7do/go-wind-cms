...
export default function Footer() {
    ...
    return (
        <View className='w-full bg-card flex justify-center'>
            <View className='flex w-full max-w-300 items-center justify-between gap-4 border-t border-border px-6 py-4 text-muted-foreground min-h-18 max-md:flex-col max-md:items-start max-md:gap-3 max-md:py-4 max-md:pb-5'>
                <View className='flex flex-wrap items-center gap-1' aria-label='Footer links'>
                ...
                <View className='flex shrink-0 items-center gap-3 max-md:w-full max-md:justify-between'>
                    <Text className='text-sm whitespace-nowrap'>
                        {t('copyright')}
                    </Text>
                    <Separator orientation='vertical' className='h-3.5 w-px bg-border max-md:hidden' />
                    <View className='flex items-center gap-1' aria-label='Social links'>
