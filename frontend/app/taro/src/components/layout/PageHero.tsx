...
const PageHero: React.FC<PageHeroProps> = ({
    ...
    return (
        <View className={cn(
            ...
            'dark:bg-linear-to-b dark:from-slate-950 dark:via-slate-900/80 dark:to-background',
            'bg-linear-to-b from-[hsl(142,70%,96%)] via-[hsl(142,50%,98%)] to-background',
            minHeight,
            padding,
        ...
        >
            {/* 装饰线条层：低透明度风轨纹理 */}
            <View className='absolute inset-0 opacity-[0.03] pointer-events-none'>
                {/* 水平流动线条 */}
                <View
