...
export default function TopNavbar({onClick}: TopNavbarProps) {
    ...
    if (isLoading) {
        return (
            <View className='flex h-full items-center gap-2'>
    ...
    return (
        <View className='flex h-full items-center gap-0.5'>
            {navigationItems.map((item) => {
                ...
                return (
                    <View
                      key={itemId}
                      className='relative'
                      onClick={() => handleMouseEnter(itemId)}
                    >
                        <View
                          className={cn(
                            ...
                            >
                                {item.children!.map((child: siteservicev1_NavigationItem) => (
                                    ...
                                    >
                                        ...
                                        <Text className='truncate'>{child.title}</Text>
                                    </View>
                                ))}
                            </View>
                        )}
