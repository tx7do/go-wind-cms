        ...
        <>
            ...
            {isExpanded && (
                <aside className='w-60 shrink-0 max-md:hidden'>
                    <View className='sticky top-24 rounded-lg border border-border bg-card p-4 pr-5 border-r border-r-border/50'>
                        <View className='mb-3 flex items-center justify-between'>
                            <Text className='flex items-center gap-2 text-sm font-semibold text-foreground'>
            ...
            {/* 折叠时的展开按钮 */}
            {!isExpanded && (
                <View className='fixed top-1/2 left-4 z-10 -translate-y-1/2'>
                    <View
                      onClick={onExpand}
                    ...
                    >
                        <XIcon name='carbon:list' />
                        <Text className='max-md:hidden'>{title}</Text>
