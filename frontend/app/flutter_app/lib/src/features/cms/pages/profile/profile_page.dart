    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: EdgeInsets.fromLTRB(
                  isMobile ? 16.w : 16, 20, isMobile ? 16.w : 16, 8),
              child: Text(
                '阅读统计',
                style: TextStyle(
          ...
          SliverToBoxAdapter(
              child: SizedBox(height: isMobile ? 24.h : 24)),
        ],
      ),
    );
  }
          ...
          children: [
            ...
            Wrap(
              ...
              children: _presetColors.map((color) {
                final isSelected = color.toARGB32() == currentSeedColor.toARGB32();
                return MouseRegion(
...
class _SettingRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Icon(icon, size: isMobile ? 20.sp : 20,
    ...
    return Card(
      ...
      child: Column(
        children: menuItems.map((item) {
          return ListTile(
            leading: Icon(item.icon, size: isMobile ? 22.sp : 22,
                color: themeData.colorScheme.onSurface.withAlpha(180)),
            title: Text(
              item.title,
              style: TextStyle(
            ...
            trailing: Icon(Icons.chevron_right, size: isMobile ? 20.sp : 20,
