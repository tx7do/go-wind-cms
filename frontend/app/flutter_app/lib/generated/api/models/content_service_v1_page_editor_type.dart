...
/// 编辑器类型
@JsonEnum()
enum ContentServiceV1PageEditorType {
  ...
  const ContentServiceV1PageEditorType(this.json);

  factory ContentServiceV1PageEditorType.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<ContentServiceV1PageEditorType> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
