...
export const usePostStore = defineStore('post', () => {
    ...
    async function getPost(id: number) {
        ...
        return await service.Get({id, locale: locale.value});
    }
    ...
    function getTranslation(post: contentservicev1_Post) {
        ...
        const locale = useLocaleIso();
        // 优先查找当前语言的翻译
        const translation = post.translations?.find((t: contentservicev1_PostTranslation) => t.languageCode === locale.value);
        // 如果找不到，回退到第一个翻译
