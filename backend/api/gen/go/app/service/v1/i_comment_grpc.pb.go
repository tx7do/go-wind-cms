...
const (
	CommentService_ListComment_FullMethodName   = "/app.service.v1.CommentService/ListComment"
	CommentService_GetComment_FullMethodName    = "/app.service.v1.CommentService/GetComment"
	CommentService_CreateComment_FullMethodName = "/app.service.v1.CommentService/CreateComment"
	CommentService_UpdateComment_FullMethodName = "/app.service.v1.CommentService/UpdateComment"
	CommentService_DeleteComment_FullMethodName = "/app.service.v1.CommentService/DeleteComment"
)
...
func (UnimplementedCommentServiceServer) ListComment(context.Context, *v1.PagingRequest) (*v11.ListCommentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListComment not implemented")
}
