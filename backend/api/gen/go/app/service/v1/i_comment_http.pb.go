...
const OperationCommentServiceCreateComment = "/app.service.v1.CommentService/CreateComment"
const OperationCommentServiceDeleteComment = "/app.service.v1.CommentService/DeleteComment"
const OperationCommentServiceGetComment = "/app.service.v1.CommentService/GetComment"
const OperationCommentServiceListComment = "/app.service.v1.CommentService/ListComment"
const OperationCommentServiceUpdateComment = "/app.service.v1.CommentService/UpdateComment"
...
func RegisterCommentServiceHTTPServer(s *http.Server, srv CommentServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/app/v1/comments", _CommentService_ListComment0_HTTP_Handler(srv))
	r.GET("/app/v1/comments/{id}", _CommentService_GetComment0_HTTP_Handler(srv))
	r.POST("/app/v1/comments", _CommentService_CreateComment0_HTTP_Handler(srv))
	r.PUT("/app/v1/comments/{id}", _CommentService_UpdateComment0_HTTP_Handler(srv))
	r.DELETE("/app/v1/comments/{id}", _CommentService_DeleteComment0_HTTP_Handler(srv))
}
