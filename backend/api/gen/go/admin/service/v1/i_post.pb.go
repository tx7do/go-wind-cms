...
const file_admin_service_v1_i_post_proto_rawDesc = "" +
	"\n" +
	"\x1dadmin/service/v1/i_post.proto\x12\x10admin.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a\x1dcontent/service/v1/post.proto2\x8c\x04\n" +
	"\vPostService\x12`\n" +
	...
	"\x06Delete\x12%.content.service.v1.DeletePostRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/admin/v1/posts/{id}B\xb5\x01\n" +
...
var file_admin_service_v1_i_post_proto_depIdxs = []int32{
	...
	5, // 5: admin.service.v1.PostService.List:output_type -> content.service.v1.ListPostResponse
	6, // 6: admin.service.v1.PostService.Get:output_type -> content.service.v1.Post
	6, // 7: admin.service.v1.PostService.Create:output_type -> content.service.v1.Post
	6, // 8: admin.service.v1.PostService.Update:output_type -> content.service.v1.Post
	7, // 9: admin.service.v1.PostService.Delete:output_type -> google.protobuf.Empty
