...
const file_admin_service_v1_i_category_proto_rawDesc = "" +
	...
	"\x06Create\x12).content.service.v1.CreateCategoryRequest\x1a\x1c.content.service.v1.Category\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/admin/v1/categories\x12w\n" +
	"\x06Update\x12).content.service.v1.UpdateCategoryRequest\x1a\x1c.content.service.v1.Category\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\x1a\x19/admin/v1/categories/{id}\x12n\n" +
	"\x06Delete\x12).content.service.v1.DeleteCategoryRequest\x1a\x16.google.protobuf.Empty\"!\x82\xd3\xe4\x93\x02\x1b*\x19/admin/v1/categories/{id}B\xb9\x01\n" +
...
var file_admin_service_v1_i_category_proto_depIdxs = []int32{
	...
	1, // 1: admin.service.v1.CategoryService.Get:input_type -> content.service.v1.GetCategoryRequest
	2, // 2: admin.service.v1.CategoryService.Create:input_type -> content.service.v1.CreateCategoryRequest
	3, // 3: admin.service.v1.CategoryService.Update:input_type -> content.service.v1.UpdateCategoryRequest
	4, // 4: admin.service.v1.CategoryService.Delete:input_type -> content.service.v1.DeleteCategoryRequest
	5, // 5: admin.service.v1.CategoryService.List:output_type -> content.service.v1.ListCategoryResponse
	6, // 6: admin.service.v1.CategoryService.Get:output_type -> content.service.v1.Category
	6, // 7: admin.service.v1.CategoryService.Create:output_type -> content.service.v1.Category
	6, // 8: admin.service.v1.CategoryService.Update:output_type -> content.service.v1.Category
	7, // 9: admin.service.v1.CategoryService.Delete:output_type -> google.protobuf.Empty
