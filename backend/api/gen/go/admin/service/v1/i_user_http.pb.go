...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List30_HTTP_Handler(srv))
	...
	r.POST("/admin/v1/users", _UserService_Create24_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update24_HTTP_Handler(srv))
...
func _UserService_List30_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Create24_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update24_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
