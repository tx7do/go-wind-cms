...
func RegisterTenantServiceHTTPServer(s *http.Server, srv TenantServiceHTTPServer) {
	...
	r.DELETE("/admin/v1/tenants/{id}", _TenantService_Delete22_HTTP_Handler(srv))
...
func _TenantService_Delete22_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
