...
func (_q *PageQuery) QueryParent() *PageQuery {
...
func (_q *PageQuery) QueryChildren() *PageQuery {
	query := (&PageClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *PageQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PageQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *PageQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PageQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *PageQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *PageQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PageQuery) WithParent(opts ...func(*PageQuery)) *PageQuery {
	query := (&PageClient{config: _q.config}).Query()
...
func (_q *PageQuery) WithChildren(opts ...func(*PageQuery)) *PageQuery {
	query := (&PageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PageQuery) prepareQuery(ctx context.Context) error {
	...
	if page.Policy == nil {
		return errors.New("ent: uninitialized page.Policy (forgotten import ent/runtime?)")
	}
	if err := page.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *PageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Page, error) {
	...
	if query := _q.withParent; query != nil {
		if err := _q.loadParent(ctx, query, nodes, nil,
			func(n *Page, e *Page) { n.Edges.Parent = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withChildren; query != nil {
		if err := _q.loadChildren(ctx, query, nodes,
			func(n *Page) { n.Edges.Children = []*Page{} },
			func(n *Page, e *Page) { n.Edges.Children = append(n.Edges.Children, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PageQuery) loadParent(ctx context.Context, query *PageQuery, nodes []*Page, init func(*Page), assign func(*Page, *Page)) error {
	ids := make([]uint32, 0, len(nodes))
	nodeids := make(map[uint32][]*Page)
	for i := range nodes {
...
func (_q *PageQuery) loadChildren(ctx context.Context, query *PageQuery, nodes []*Page, init func(*Page), assign func(*Page, *Page)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(page.FieldParentID)
	}
	query.Where(predicate.Page(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(page.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(page.Table, page.Columns, sqlgraph.NewFieldSpec(page.FieldID, field.TypeUint32))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(page.FieldParentID)
		}
	}
