...
func (_q *SectionQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *SectionQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *SectionQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *SectionQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *SectionQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *SectionQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SectionQuery) prepareQuery(ctx context.Context) error {
	...
	if section.Policy == nil {
		return errors.New("ent: uninitialized section.Policy (forgotten import ent/runtime?)")
	}
	if err := section.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *SectionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(section.Table, section.Columns, sqlgraph.NewFieldSpec(section.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *SectionQuery) Modify(modifiers ...func(s *sql.Selector)) *SectionSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *SectionSelect) Modify(modifiers ...func(s *sql.Selector)) *SectionSelect {
