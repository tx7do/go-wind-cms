...
const (
	// Label holds the string label denoting the sectiontranslation type in the database.
	Label = "section_translation"
	...
	// Table holds the table name of the sectiontranslation in the database.
	Table = "section_translations"
)

// Columns holds all SQL columns for sectiontranslation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the SectionTranslation queries.
