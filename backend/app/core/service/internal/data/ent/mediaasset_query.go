...
func (_q *MediaAssetQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *MediaAssetQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *MediaAssetQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *MediaAssetQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *MediaAssetQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *MediaAssetQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MediaAssetQuery) prepareQuery(ctx context.Context) error {
	...
	if mediaasset.Policy == nil {
		return errors.New("ent: uninitialized mediaasset.Policy (forgotten import ent/runtime?)")
	}
	if err := mediaasset.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *MediaAssetQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mediaasset.Table, mediaasset.Columns, sqlgraph.NewFieldSpec(mediaasset.FieldID, field.TypeUint32))
	_spec.From = _q.sql
