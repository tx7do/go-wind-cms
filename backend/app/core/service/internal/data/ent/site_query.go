...
func (_q *SiteQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *SiteQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *SiteQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *SiteQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *SiteQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *SiteQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SiteQuery) prepareQuery(ctx context.Context) error {
	...
	if err := site.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *SiteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(site.Table, site.Columns, sqlgraph.NewFieldSpec(site.FieldID, field.TypeUint32))
	_spec.From = _q.sql
