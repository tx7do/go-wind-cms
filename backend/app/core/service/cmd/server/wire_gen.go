...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	statsRepo := data.NewStatsRepo(context, entClient)
	...
	contentModelRepo := data.NewContentModelRepo(context, entClient)
	postService := service.NewPostService(context, postRepo, searchService, taskService, contentModelRepo)
	...
	categoryService := service.NewCategoryService(context, categoryRepo, contentModelRepo)
	...
	pageService := service.NewPageService(context, pageRepo, contentModelRepo)
	sectionService := service.NewSectionService(context, sectionRepo)
	contentModelService := service.NewContentModelService(context, contentModelRepo)
